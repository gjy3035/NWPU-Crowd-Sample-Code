...
__C_NWPU.DATA_PATH = '/media/D/NWPU-Crowd-methods/ProcessedData/Data.2019.11/NWPU/1204_min_'+ str(__C_NWPU.TRAIN_SIZE[0]) + 'x' + str(__C_NWPU.TRAIN_SIZE[1]) + '_mod16_2048'   
